...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},r,a]}}})());hljs.registerLanguage("latex",(()=>{"use strict";return e=>{const n=[{
...
},{begin:s+":",end:":",returnBegin:!0,returnEnd:!0,relevance:0}])}}})());hljs.registerLanguage("julia",(()=>{"use strict";return e=>{
...
}],a.contains=n.contains,n}})());hljs.registerLanguage("cpp",(()=>{"use strict";return e=>{const t=(e=>{
...
relevance:0}]}}})());hljs.registerLanguage("less",(()=>{"use strict";return e=>{
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:a}}})());hljs.registerLanguage("julia-repl",(()=>{"use strict";return a=>({
name:"Julia REPL",contains:[{className:"meta",begin:/^julia>/,relevance:10,
starts:{end:/^(?![ ]{6})/,subLanguage:"julia"},aliases:["jldoctest"]}]})})());hljs.registerLanguage("typescript",(()=>{"use strict"
...
contains:a,keywords:e,illegal:"\\S"}}})());hljs.registerLanguage("dos",(()=>{"use strict";return e=>{
...
className:"number",begin:"\\b\\d+",relevance:0},t]}}})());hljs.registerLanguage("arduino",(()=>{"use strict";return e=>{const t=(e=>{
...
t.name="Arduino",t.aliases=["ino"],t.supersetOf="cpp",t}})());hljs.registerLanguage("xml",(()=>{"use strict";function e(e){
...
begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}})());hljs.registerLanguage("dart",(()=>{"use strict";return e=>{const n={
...
className:"meta",begin:"@[A-Za-z]+"},{begin:"=>"}]}}})());hljs.registerLanguage("c",(()=>{"use strict";return e=>{const t=(e=>{
function t(e){return"(?:"+e+")?"}var n=e.COMMENT("//","$",{contains:[{
begin:/\\\n/}]
}),r="[a-zA-Z_]\\w*::",a="(decltype\\(auto\\)|"+t(r)+"[a-zA-Z_]\\w*"+t("<.*?>")+")",i={
className:"keyword",begin:"\\b[a-z\\d_]*_t\\b"},s={className:"string",
...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},r]}}})());hljs.registerLanguage("bash",(()=>{"use strict";function e(...e){
...
aliases:["yml","YAML"],contains:b}}})());hljs.registerLanguage("lua",(()=>{"use strict";return e=>{
...
starts:{end:/[^\\]$/,subLanguage:"bash"}}],illegal:"</"})})());hljs.registerLanguage("sql",(()=>{"use strict";return e=>{
